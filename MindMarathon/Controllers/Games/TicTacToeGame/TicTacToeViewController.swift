...
//                stopwatch.invalidate()
//                showAlertAboutFinishGame(title: "End game".localize(), message: )
//                saveResult(result: WhiteBoardModel(nameGame: "tictactoe", resultGame: "draw", countStep: stepCount.description, timerGame:  seconds))
//                return
//            }
