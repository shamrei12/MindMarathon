...
//    }
//    
//    private let keyboardView = UIHostingController(rootView: CustomKeyboardView(historyUserMove: .constant([""]), curentStep: .constant(0), curentWord: .constant(""), size: .constant(5))).view!
